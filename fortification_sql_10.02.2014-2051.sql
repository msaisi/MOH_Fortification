...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2014 at 08:50 PM
...
CREATE DATABASE foritification; USE fortification;
...
INSERT INTO `internalfortifieda2` (`transactionNumber`, `dates`, `supplierCOA`, `noOfDrums`, `lotId`, `expiryDate`, `manufacturerCompName`, `transactedBy`, `dateOfReporting`) VALUES
(1, '2012-05-22', '54', 56, '6', '2012-05-08', 'Salt Iod', '', '0000-00-00'),
(2, '2012-06-05', 'qwe334', 44, 'er34', '2012-11-21', 'TeraChloro Inc.', '', '0000-00-00');
...
CREATE TABLE IF NOT EXISTS `internalfortifieda2dispatched` (
...
(7, '2012-05-29', 4, 4, 4, '01:33 PM', '01:39 PM', 5, 'ty', 'Kensalt'),
(8, '2012-06-06', 23, 2, 22, '03:04 PM', '03:04 PM', 14.5, 'a', 'Kensalt');
...
(13, '2014-02-04', 1, 'g', 'g', '7865432', 'Ken Iodization I'),
(14, '2014-02-04', 1, 'g', 'g', '6754321', 'Ken Iodization I'),
(15, '2014-02-04', 1, 'g', 'g', '6754327', 'Ken Iodization I'),
(16, '2014-02-04', 1, 'g', 'g', '6754320', 'Ken Iodization I'),
(17, '2014-02-04', 1, 'g', 'g', '6754351', 'Ken Iodization I');
...
INSERT INTO `smallscalea1` (`transactionNumber`, `dates`, `harvestYear`, `manufacturerCompName`, `weightKg`, `lotNumber`, `contentOfIodine`) VALUES
(2, '2012-05-29', 0, 'Oxfirm', 5, 'rtt', 0),
(3, '2012-05-29', 0, 'Salt Iod', 5, 'rt', 0),
(4, '2012-05-29', 0, 'Oxfirm', 5, 'rtr', 0),
(5, '2012-05-30', 0, 'TeraChloro Inc.', 5, 'rtrt', 0);
...
CREATE TABLE IF NOT EXISTS `smallscalea1dispatched` (
...
INSERT INTO `smallscalea2` (`transcationNumber`, `harvestYear`, `dates`, `manufacturerCompName`, `weightKg`, `lotNumber`, `contentIodine`) VALUES
(2, 0, '2012-05-14', 'Kensalt', 13, '4', 0),
(3, 0, '2012-05-14', 'Oxfirm', 45, 'er4', 0),
(4, 0, '2012-05-06', 'Salt Iod', 67, 'r4r4', 0),
(5, 0, '2012-05-14', 'TeraChloro Inc.', 23, '45tr', 0),
(6, 0, '2012-05-21', 'Kensalt', 32, 't54', 0),
(7, 0, '2012-05-28', 'Salt Iod', 23, 'tr454', 0);
...
CREATE TABLE IF NOT EXISTS `smallscalea2dispatched` (
